...
const projects = [
  ...
  },
  {
    name: "Patrola.ba",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magnaboris nisi ut aliquip ex ea commodo consequat.",
    tags: [
      {
        name: "react",
        color: "blue-text-gradient",
